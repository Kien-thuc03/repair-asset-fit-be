...
export class EmailService {
    ...
    constructor(private configService: ConfigService) {
        ...
        if (!sendGridApiKey) {
            this.logger.warn('⚠️ SendGrid API key is missing. Email service will not work properly.');
        ...
        try {
            ...
            if (error instanceof Error) {
                ...
                if (errorMsg.includes('unauthorized') || errorMsg.includes('api key')) {
                    ...
                    errorMessage = 'Không có quyền gửi email. Vui lòng kiểm tra quyền của SendGrid API key.';
