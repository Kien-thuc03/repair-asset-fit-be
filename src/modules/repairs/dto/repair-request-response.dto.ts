...
class ComponentInfoDto {
  @Expose()
  @ApiProperty({ description: "ID linh kiện" })
  id: string;

  @Expose()
  @ApiProperty({ description: "Tên linh kiện" })
  name: string;

  @Expose()
  @ApiProperty({ description: "Loại linh kiện" })
  type: string;

  @Expose()
  @ApiProperty({ description: "Thông số kỹ thuật" })
  specifications: string;

  @Expose()
  @ApiProperty({ description: "Trạng thái linh kiện" })
  status: string;
}
...
export class RepairRequestResponseDto {
  ...
  @Type(() => UserInfoDto)
  @ApiPropertyOptional({
    description: "Thông tin người báo lỗi",
    type: UserInfoDto,
  })
  ...
  @Type(() => UserInfoDto)
  @ApiPropertyOptional({
    description: "Thông tin kỹ thuật viên",
    type: UserInfoDto,
  })
  ...
  @ApiPropertyOptional({
    description: "Danh sách linh kiện liên quan",
    type: [ComponentInfoDto],
  })
