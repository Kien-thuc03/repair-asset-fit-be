import { IsString, IsNotEmpty, IsOptional, IsUUID, IsArray, MaxLength, IsEnum } from 'class-validator';
...
export class CreateRepairRequestDto {
  ...
  @IsOptional()
  @IsEnum(ErrorType, { message: 'Loại lỗi phải là một trong các giá trị hợp lệ' })
  errorType?: ErrorType;

  @ApiProperty({ 
    description: 'Mô tả chi tiết tình trạng lỗi',
    example: 'Máy tính không khởi động được, có mùi cháy từ nguồn điện 500W'
  })
